...
namespace AmyRoseMod.Characters.Survivors.Amy.Achievements
{
    ...
    public class AmyGrandMasteryAchievement : BaseMasteryAchievement
    {
        public const string identifier = AmySurvivor.AMY_PREFIX + "grandmasteryAchievement";
        public const string unlockableIdentifier = AmySurvivor.AMY_PREFIX + "grandmasteryUnlockable";
